...
Controller.prototype.login = function ( req, res ) {
	...
	eval( "data = " +  data + ";" );
 	function login_callback( result ) {
		...
		//console.log("Contorller.login.login_callback: "+  JSON.stringify(result) );
		if( result != null ) {
			obj.success = true;
		...
		//console.log("Controller.login.login_callback will render " + JSON.stringify( obj , null, 4) ) ;
		_view.render (res, obj );
	};
...
Controller.prototype.count = function ( req, res) {
	...
	_model.collection_name = collection;
	_model.count( selector, options, _callback );
};
...
Controller.prototype.get_list = function ( req, res ) {
	...
	var selector = {};
	var options = {};
	console.log("Controller.get_list: collection : " + collection );
   
	function find_callback( results ) {

	 	_view.render ( res , results);
	};
...
Controller.prototype.get_air21branches = function ( req, res ) {
	...
	var selector = {};
	var options = {};
	console.log("Controller.get_air21branches: branches "  );
...
Controller.prototype.forgot_password = function ( req, res ) {
	var data = req.body.data;
	eval( "data = " +  data + ";" );
	...
	_model.forgot_password( email,   _callback );
};

Controller.prototype.email = function ( req, res ) {
	var data = req.body.data;
	eval( "data = " +  data + ";" );
